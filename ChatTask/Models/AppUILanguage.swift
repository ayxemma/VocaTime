...
struct AppStrings {
    ...
    static let english = AppStrings(
        ...
        voiceListening: "Listening… tap to stop, or pause to finish",
    ...
    static let chineseSimplified = AppStrings(
        ...
        voiceListening: "正在听…说完可点一下结束，也可以停顿后自动结束",
        voiceProcessing: "处理中…",
    ...
    static let spanish = AppStrings(
        ...
        voiceListening: "Escuchando… toca detener o haz una pausa para terminar.",
